...
// Yönlendirme için useRouter import edildi
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        ...
                        <button 
                            onClick={handleLoginRedirect} // Yönlendirme işlevi eklendi
                            className="bg-white text-black hover:bg-purple-400 hover:text-white transition-all px-4 py-2 rounded-full font-semibold text-sm"
                        >
                            Giriş Yap
                        </button>
                    </div>
            ...
            {isOpen && (
                ...
                >
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        {/* Mobil Menüdeki Giriş Yap Butonu Güncellendi */}
                        <button 
                            onClick={handleLoginRedirect}
                            className="w-full text-left px-3 py-2 rounded-md text-base font-medium hover:bg-gray-900 text-purple-400"
                        >
                            Giriş Yap
                        </button>
                    </div>
...
// --- Diğer Bileşenler ve Ana Fonksiyonlar (Aşağıda Değişiklik Yok) ---
